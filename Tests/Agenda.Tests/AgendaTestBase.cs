...
using Agenda.Migrations.SeedData;
...
{
    public abstract class AgendaTestBase : AbpIntegratedTestBase
    {
        protected AgendaTestBase()
        {
            //Seed initial data
        ...
        protected override void AddModules(ITypeList<AbpModule> modules)
        {
            ...
            modules.Add<AgendaApplicationModule>();
            modules.Add<AgendaDataModule>();
        }

        public void UsingDbContext(Action<AgendaDbContext> action)
        {
            using (var context = LocalIocManager.Resolve<AgendaDbContext>())
            {
        ...
        public T UsingDbContext<T>(Func<AgendaDbContext, T> func)
        {
            T result;
